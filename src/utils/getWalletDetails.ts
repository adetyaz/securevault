...
export default async function getWalletDetails({ client }: any) {
	try {
		const wallet = Wallet.fromSeed(process.env.NEXT_PUBLIC_SEED!) // Convert the seed to a wallet : https://xrpl.org/cryptographic-keys.html
